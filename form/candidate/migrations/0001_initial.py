# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-06-05 17:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exp_salary', models.IntegerField(blank=True, default=0, verbose_name='Зарплата')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(blank=True, choices=[(0, 'Мужской'), (1, 'Женский'), (2, 'Не указан')], default=2, verbose_name='Пол')),
                ('registration', models.TextField(blank=True, default='', verbose_name='Адрес прописки')),
                ('residence', models.BooleanField(default=True, verbose_name='Адрес проживания совпадает с адресом прописки')),
                ...
                ('ref1_full_name', models.CharField(max_length=100, verbose_name='Фамилия, имя, отчество')),
                ('ref1_position', models.CharField(blank=True, max_length=50, verbose_name='Должность')),
                ...
                ('ref2_full_name', models.CharField(max_length=100, verbose_name='Фамилия, имя, отчество')),
                ('ref2_position', models.CharField(blank=True, max_length=50, verbose_name='Должность')),
